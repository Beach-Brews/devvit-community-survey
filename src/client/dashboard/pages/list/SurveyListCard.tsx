        ...
        <div className="text-sm p-2 flex flex-col justify-between gap-2 text-neutral-700 dark:text-neutral-300 rounded-md bg-white shadow-md dark:bg-neutral-900 dark:shadow-neutral-800">
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-1">
                    {!isPublished && (<div className="p-0.5 rounded-lg cursor-pointer hover:bg-blue-200 hover:text-blue-700 hover:dark:bg-blue-700 hover:dark:text-blue-200"><PencilSquareIcon className="size-5" /></div>)}
                    {(!isPublished || isClosed) && (<div className="p-0.5 rounded-lg cursor-pointer hover:bg-rose-200 hover:text-rose-700 hover:dark:bg-rose-700 hover:dark:text-rose-200"><TrashIcon className="size-5" /></div>)}
                    {isPublished && !isClosed && (<div className="p-0.5 rounded-lg cursor-pointer hover:bg-rose-200 hover:text-rose-700 hover:dark:bg-rose-700 hover:dark:text-rose-200"><StopCircleIcon className="size-5" /></div>)}
                </div>
            </div>
            ...
            <div className="flex justify-between items-center min-h-6">
                {(isPublished
                    ? <div className="flex items-center cursor-pointer rounded-lg px-1 hover:bg-blue-200 hover:text-blue-700 hover:dark:bg-blue-700 hover:dark:text-blue-200"><PresentationChartBarIcon className="size-5" /> 1,462</div>
                    : <div></div>
                )}
