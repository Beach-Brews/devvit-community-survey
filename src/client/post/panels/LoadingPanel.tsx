...
export const LoadingPanel = () => {
    return (
        <div className="flex flex-col gap-4 justify-between items-center h-full animate-pulse">
            <div className="w-full flex justify-between">
                <div className="h-6 bg-neutral-300 rounded-full dark:bg-neutral-700 w-1/4"></div>
                <div className="h-6 bg-neutral-300 rounded-full dark:bg-neutral-700 w-1/3"></div>
            </div>
            <div className="w-full flex flex-col flex-grow h-[0px] gap-4 justify-center items-center text-neutral-700 dark:text-neutral-300">
