# Community Survey - Terms of Use and Privacy Policy
...
You may use the App only for lawful purposes and in accordance with these Terms. You are responsible for your own actions while using the App. You agree to use the App in good faith and not for any deceptive, harmful, or abusive purpose. You acknowledge that features and responses provided by the App are intended to enhance user experience, not to mislead, exploit, or cause harm. You further agree not to intentionally misuse or manipulate the App in ways that undermine its functionality, other users’ experiences, or the broader Reddit community.
...
* ANY INFORMATION PROVIDED THROUGH THE APP IS ACCURATE, RELIABLE, OR COMPLETE.

YOU USE THE APP AT YOUR OWN RISK.

### 5. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW, WE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF DATA, LOSS OF PROFITS, OR SYSTEM FAILURE, ARISING OUT OF OR RELATED TO YOUR USE OF THE APP, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.

### 6. Changes to the App

We or Reddit may modify, suspend, or discontinue the App at any time without notice. We will not be liable for any such modification or discontinuation.
...
Information is used only to enable the App’s features — for example:
...
Data is retained only as long as necessary for the App’s intended functionality or as long as Reddit retains it through its platform systems. Users may remove App-related data by deleting their interactions where Reddit allows it.

### 5. Data Security

This App relies on **Reddit’s platform security measures**. As no data leaves Reddit’s environment, the App does not provide additional independent security systems.

### 6. Children’s Privacy

This App does not target or knowingly collect information from individuals under the age of 13. Users must follow Reddit’s age restrictions.
